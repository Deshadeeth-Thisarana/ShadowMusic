...
from ShadowMusic.config import BROADCAST_AS_COPY, LOG_CHANNEL
from ShadowMusic.helpers.database import db, dcmdb
    ...
    if ban_status["is_banned"]:
        if (
            ...
            await cmd.reply_text(
                "Sorry To Say! but **You are banned** 😂! Ask from **@DeshadeethThisarana** if you think this was an mistake.",
                quote=True,
            )
            return
